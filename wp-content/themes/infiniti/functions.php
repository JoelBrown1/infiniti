...
function infiniti_scripts(){
	wp_register_script('tubular', get_bloginfo('template_url').'/js/jquery.tubular.1.0.js');
	...
	wp_enqueue_script('modernizr', get_bloginfo('template_url').'/js/modernizr.js', array("jquery"), "", false);

	if(is_front_page()){
		wp_enqueue_style('home-page', get_bloginfo('template_url').'/css/stylesheets/homepage.css');
		wp_enqueue_script('tubular', get_bloginfo('template_url').'/js/jquery.tubular.1.0.js', array('jquery'), "", false);
		wp_enqueue_script('home', get_bloginfo('template_url').'/js/home.js', array('jquery', 'tubular'), "", true);
	} else {
     ...
     * <!--[if lte IE 8]> ... <![endif]-->
     */
	/*wp_enqueue_style( 'smithsonianchannel-ie', get_stylesheet_directory_uri() . "/css/stylesheets/ie.css");
    $wp_styles->add_data( 'smithsonianchannel-ie', 'conditional', 'lt IE 9' );*/
}
